import {
  ...
  useFocusGuards,
  useId
} from "./chunk-VMFGQ5YO.js";
import {
  dist_exports as dist_exports6
} from "./chunk-X5VHD4QE.js";
import {
  dist_exports as dist_exports2
} from "./chunk-5644ULPJ.js";
import {
  clamp,
  createCollection,
  createCollection2,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React41 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState19 = React41.useState, useEffect23 = React41.useEffect, useLayoutEffect = React41.useLayoutEffect, useDebugValue = React41.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var NAME4 = "Label";
var Label5 = React21.forwardRef((props, forwardedRef) => {
...
var Menubar = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const [currentTabStopId, setCurrentTabStopId] = React22.useState(null);
    return (0, import_jsx_runtime20.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React22.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React22.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React22.useCallback(
          (value2) => {
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React22.useRef(false);
...
var MenubarGroup = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React22.forwardRef((props, forwardedRef) => {
...
var MenubarArrow = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React22.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React22.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React23.forwardRef((props, forwardedRef) => {
  ...
  const [size, setSize] = React23.useState(null);
...
function isSlottable4(child) {
  return React26.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime25.jsx)(PortalProvider4, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime25.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime25.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContentModal = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(Combination_default, { as: Slot7, allowPinchZoom: true, children: (0, import_jsx_runtime25.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime25.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Progress = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsx)(ProgressProvider, { scope: __scopeProgress, value, max, children: (0, import_jsx_runtime26.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max,
        "aria-valuemin": 0,
...
var ProgressIndicator = React28.forwardRef(
  (props, forwardedRef) => {
...
var RadioGroup3 = React29.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRadioGroup,
      name,
...
var RadioGroupItem = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    const isArrowKeyPressedRef = React29.useRef(false);
    React29.useEffect(() => {
...
var RadioGroupIndicator = React29.forwardRef(
  (props, forwardedRef) => {
...
var Separator3 = React32.forwardRef((props, forwardedRef) => {
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React35.useState(0);
  const isFocusedToastEscapeKeyDownRef = React35.useRef(false);
  const isClosePausedRef = React35.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime33.jsx)(Collection7.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime33.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React35.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React35.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React35.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const wrapperRef = React35.useRef(null);
    const headFocusProxyRef = React35.useRef(null);
    const tailFocusProxyRef = React35.useRef(null);
    ...
    const getSortedTabbableCandidates = React35.useCallback(
      ({ tabbingDirection }) => {
    ...
    return (0, import_jsx_runtime33.jsxs)(
      Branch,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime33.jsx)(Collection7.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime33.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime33.jsx)(
            FocusProxy,
            {
...
var FocusProxy = React35.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React35.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React35.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React35.useRef(null);
    const swipeDeltaRef = React35.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React35.useRef(0);
    const closeTimerRemainingTimeRef = React35.useRef(duration);
    ...
    const startTimer = React35.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React35.useMemo(() => {
    ...
    return (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [
      ...
      (0, import_jsx_runtime33.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM2.createPortal(
        (0, import_jsx_runtime33.jsx)(Collection7.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime33.jsx)(
          Root2,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React35.useState(false);
  const [isAnnounced, setIsAnnounced] = React35.useState(false);
...
var ToastAnnounceExclude = React35.forwardRef((props, forwardedRef) => {
...
var NAME6 = "Toggle";
var Toggle = React36.forwardRef((props, forwardedRef) => {
...
function isSlottable6(child) {
  return React39.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime38.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime38.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime38.jsx)(Portal, { asChild: true, container, children }) }) });
};
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime38.jsxs)(
          Content,
          {
            ...
            children: [
              (0, import_jsx_runtime38.jsx)(Slottable8, { children }),
              (0, import_jsx_runtime38.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime38.jsx)(Root3, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
